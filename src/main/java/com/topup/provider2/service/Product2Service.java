...
public class Product2Service {
    ...
    public void findAllProduct2() throws IOException, TimeoutException {
        ...
        List<Provider2> provider = session.selectList("topupPulsa.listIndosatProduct");
    ...
    public void findProduct2PriceToDB(String message) throws IOException, TimeoutException {
        ...
        Provider2 provider  = (Provider2) session.selectOne("topupPulsa.searchIndosatProductById", code);
    ...
    public void countProduct2DB(String message) throws IOException, TimeoutException {
        ...
        Provider2 provider = session.selectOne("topupPulsa.searchIndosatProductById", Integer.parseInt(message));

        provider.tambahTerjual();

        int hasil = session.update("topupPulsa.updateIndosatCount", provider);
        session.commit();
