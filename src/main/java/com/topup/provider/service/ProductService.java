...
public class ProductService {
    ...
    public void findAllProduct() throws IOException, TimeoutException {
        ...
        List<Provider> provider = session.selectList("topupPulsa.listTelkomselProduct");
    ...
    public void findProductPriceToDB(String message) throws IOException, TimeoutException {
        ...
        Provider provider  = (Provider) session.selectOne("topupPulsa.searchTelkomselProductById", code);
    ...
    public void countProductDB(String message) throws IOException, TimeoutException {
        ...
        Provider provider = session.selectOne("topupPulsa.searchTelkomselProductById", message);

        provider.tambahTerjual();

        int hasil = session.update("topupPulsa.updateTelkomselCount", Integer.parseInt(message));
        session.commit();
